...
| Consumer agent (dev harness, on-device Gemini Nano) | ✅ `src/agent/dev-agent.user.js` **v0.9.5** — **manual JSON tool loop**; verified end-to-end (tool call → page navigation observed) |
